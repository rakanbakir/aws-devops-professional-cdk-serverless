...
class EKSStack(core.Stack):
    def __init__(self, scope: core.Construct, id: str, vpc: ec2.Vpc, **kwargs) -> None:
        ...
        cluster = eks.Cluster(self, 'dev',
            ...
            default_capacity=0,
            # kubectl_enabled=True, # this is a depreciated parameter, if you need to use it you need another module 'aws-cdk.aws-eks-legacy'
        ...
        ng = cluster.add_nodegroup_capacity('eks-ng',
            ...
            remote_access=eks.NodegroupRemoteAccess(ssh_key_name='devops')                                    
        )
